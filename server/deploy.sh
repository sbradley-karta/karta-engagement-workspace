...
gcloud run deploy "$SERVICE" --source . --region "$REGION" --project "$PROJECT" --allow-unauthenticated \
  ...
  --set-env-vars "AUTH_MODE=entra,MCP_PATH=/mcp,AZURE_CLIENT_ID=9056b184-4a0f-4f44-9b5f-77d52124fb0b,AZURE_TENANT_ID=e079c544-3de0-440a-a999-7f424555afff,BASE_URL=${BASE_URL},REQUIRED_SCOPE=assemble,GRAPH_SCOPES=User.Read Files.ReadWrite.All,OAUTH_STORAGE=memory" \
